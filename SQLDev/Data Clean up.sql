...
-- No changes are needed for the NULL values in total_laid_off, percentage_laid_off, and funds_raised_millions
-- These are kept as NULL for calculations during further analysis (EDA)
